...
export function ChatInput({ onSendMessage, onAbortGeneration, isLoading, disabled }: ChatInputProps) {
      ...
      <div className="relative">
        ...
        {isLoading ? (
          <button
            type="button"
            onClick={handleAbort}
            className="absolute right-2.5 top-1/2 -translate-y-1/2 p-1.5 rounded-full transition-all duration-200 bg-red-500 text-white hover:bg-red-600 active:bg-red-700 shadow-sm"
            title="停止生成"
          >
